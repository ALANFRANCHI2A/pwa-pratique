...
function loadTechnologies(technos) {
    ...
    fetch('https://us-central1-pwa-technos-alanfranchi.cloudfunctions.net/getTechnos')
        .then(response => {
            response.json()
                .then(technos => {
...
if(navigator.serviceWorker) {
    ...
    navigator.serviceWorker
        ...
        .then(registration =>{
            ...
            const publicKey = "BK6_icl_zhbsQLbVgy1XZvCNlVouYkF0FM5qbqhNUIjg8YPEaAbILSv8H9EwX4Gu3md5mNrBYLCtj-E2c_kjHfQ";
